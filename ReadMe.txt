========================================================================
    コンソール アプリケーション : SourcePrac プロジェクトの概要
========================================================================

AppWizard はユーザー用に SourcePrac アプリケーションを作成しました。  
このファイルには SourcePrac アプリケーションを構成している
各ファイルの概要が含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル SourcePrac.pch、
