...
//---------------------------------------------------------------
		...
		{
			printf("%2dÅ©  |",row+1);								//print the row number
...
//----------------------------------------------------------------2 points gainÅ™
	//if(counted==1)return;		//return		//2014.03.13 í£óŸ ñ≥å¯Ç…Ç»ÇÈ
	return;										//2014.03.13 í£óŸ êVãKÅAreturn anyway
